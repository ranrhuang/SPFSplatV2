...
def unproject(
    ...
    # print("coordinates", coordinates.shape, coordinates) # (b, v, h, w, 2)
...
def get_world_rays(
    ...
    directions = directions / directions.norm(dim=-1, keepdim=True) # (b, v, h, w, 3)
    # print("directions", directions.shape)

    # Transform ray directions to world coordinates.
    directions = homogenize_vectors(directions)
    directions = transform_cam2world(directions, extrinsics)[..., :-1] # (b, v, h, w, 3)
    # print("directions2", directions.shape)

    # Tile the ray origins to have the same shape as the ray directions.
    origins = extrinsics[..., :-1, -1].broadcast_to(directions.shape) # (b, v, h, w, 3)
